...
/**
 * Classe que contém as opções do menu de relatórios.
 * 
...
public class MenuRelatorio {
	...
	private int apresentarOpcoesMenu() {
		...
		System.out.println("\nOpções:");
		System.out
				.println(OPCAO_MENU_RELATORIO_TOTAL_RECEITAS_USUARIO + " - Relatório - Total de Receitas dos Usuários");
		System.out.println(OPCAO_MENU_RELATORIO_TOTAL_RECEITAS_USUARIO_POR_PERIODO
				+ " - Relatório - Total de Receitas dos Usuários por Período");
		System.out
				.println(OPCAO_MENU_RELATORIO_TOTAL_DESPESAS_USUARIO + " - Relatório - Total de Despesas dos Usuários");
		System.out.println(OPCAO_MENU_RELATORIO_TOTAL_DESPESAS_USUARIO_POR_PERIODO
				+ " - Relatório - Total de Despesas dos Usuários por Período");
		System.out.println(OPCAO_MENU_RELATORIO_TOTAL_DESPESAS_USUARIO_ABERTAS_POR_PERIODO
	...
	private void gerarRelatorioTotalReceitasUsuario() {
		...
		ArrayList<LancamentoUsuarioDTO> listaLancamentosUsuarioDTO = controladoraRelatorio
				.gerarRelatorioTotalReceitasUsuarioController();
	...
	private void gerarRelatorioTotalDespesasUsuario() {
		ControladoraRelatorio controladoraRelatorio = new ControladoraRelatorio();
		ArrayList<LancamentoUsuarioDTO> listaLancamentosUsuarioDTO = controladoraRelatorio
				.gerarRelatorioTotalDespesasUsuarioController();
	...
	private void gerarRelatorioTotalReceitasUsuariosPorPeriodo() {
		...
		ControladoraRelatorio controladoraRelatorio = new ControladoraRelatorio();
		ArrayList<LancamentoUsuarioDTO> listaLancamentosUsuarioDTO = controladoraRelatorio
				.gerarRelatorioTotalReceitasUsuariosPorPeriodoController(lancamentoUsuarioDTO);
	...
	private void gerarRelatorioTotalDespesasUsuariosPorPeriodo() {
		...
		ControladoraRelatorio controladoraRelatorio = new ControladoraRelatorio();
		ArrayList<LancamentoUsuarioDTO> listaLancamentosUsuarioDTO = controladoraRelatorio
				.gerarRelatorioTotalDespesasUsuariosPorPeriodoController(lancamentoUsuarioDTO);
	...
	private void gerarRelatorioTotalDespesasUsuarioAbertasPorPeriodo() {
		...
		ControladoraRelatorio controladoraRelatorio = new ControladoraRelatorio();
		ArrayList<LancamentoUsuarioDTO> listaLancamentosUsuarioDTO = controladoraRelatorio
				.gerarRelatorioTotalDespesasUsuariosAbertasPorPeriodoController(lancamentoUsuarioDTO);
